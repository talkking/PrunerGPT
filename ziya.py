...
from quant import *
import bisect
from sensitivity.ziya13B import  hessian_trace
    ...
    for i in range(len(layers)):
        ...
        for names in sequential:
            ...
            def get_layer_sparisty(layer):
                ...
                rank = sorted_sen.index(sensitivity[l])
                half_width = 0.1
                lower_bound = 1 - args.sparsity - half_width
                upper_bound = 2 * (1 - args.sparsity) - lower_bound
...
if __name__ == "__main__":
    ...
    if (args.sparsity or args.prunen) and not args.gmp:
        ...
        def get_sensitivity(sparsity_way):
            sensitivity = []   ## weight-level sensitivity
            sen = [0]*len(model.model.layers)  #layer-level sensitivity 
            #import pdb; pdb.set_trace()
            dict = {}
            clayer = 0
            total_weight = []
