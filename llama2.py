...
from quant import *
import bisect
from sensitivity.llama2_13B import hessian_trace
...
if __name__ == "__main__":
    ...
    if (args.sparsity or args.prunen) and not args.gmp:
        tick = time.time()
        #sensitivity, total_weight = llama2_sequential(model, dataloader, DEV, method="sensitivity", sparsity_way=args.sparsity_way)
    ...
    testdata = ["wikitext2", "ptb"] #["wikitext2", "ptb", "c4"]
